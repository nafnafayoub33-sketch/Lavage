...
Project rules for the `m3allem/` folder. Read this before writing any code here.
...
> direction, and never edit anything outside `m3allem/`.
...
- Do not touch anything outside `m3allem/`.
