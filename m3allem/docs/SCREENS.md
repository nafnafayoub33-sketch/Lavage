...
- **Contents:** hero with a trade + city search, grid of trades with icons, "how it
  works" in three steps, a strip for tradesmen with the value proposition and a
  *Become a m3allem* button
- **Actions:** search · pick a trade · sign in · register
