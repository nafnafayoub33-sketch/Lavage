...
const ar = {
  ...
  owner: {
    ...
    // O1 — registration
    registerTitle: 'سجل اللافاج ديالك',
    stepIdentity: 'الاسم', stepLocation: 'المكان',
    stepPhotos: 'التصاور', stepDetails: 'التفاصيل',
    washNameHint: 'مثلا: لافاج النور',
    washDescriptionHint: 'شنو كيميزك؟',
    washAddressHint: 'الزنقة والرقم',
    washCity: 'المدينة',
    pinHint: 'حرك النقطة حتى توصل لبلاصة اللافاج بالضبط.',
    pinHelp: 'الكليان غادي يمشي لهاد النقطة. تأكد منها.',
    addPhotos: 'زيد تصاور',
    removePhoto: 'حيد هاد التصويرة؟',
    photosCount: '{{count}} تصاور — خاصك {{min}} على الأقل',
    photosPermission: 'خاصنا الإذن باش نوصلو للتصاور.',
    photosWhy: 'التصاور هي أول حاجة كيشوف الكليان. دير 3 على الأقل: الواجهة، البلاصة، والخدمة.',
    reviewTitle: 'عاود شوف قبل ما تصيفط',
    submitApplication: 'صيفط الطلب',
    fixBeforeSubmit: 'باقي شي حاجة ناقصة.',
    // problems
    problemNameMissing: 'خاص اسم اللافاج.',
    problemAddressMissing: 'خاص العنوان.',
    problemCityMissing: 'خاصة المدينة.',
    problemPinMissing: 'حدد البلاصة فالخريطة.',
    problemPinOutsideMorocco: 'هاد النقطة ماشي فالمغرب.',
    problemTooFewPhotos: 'خاصك {{count}} تصاور على الأقل.',
    problemTooManyPhotos: 'بزاف ديال التصاور.',
    problemBaysOutOfRange: 'عدد البلايص ماشي معقول.',
    problemHoursIdentical: 'وقت الحل ووقت السد بحال بحال.',
    // O2 — waiting
    pendingTitle: 'الطلب ديالك عند الإدارة',
    pendingBody: 'غادي نجاوبوك فأقل من 48 ساعة.',
    rejectedTitle: 'الطلب ديالك ما تقبلش',
    rejectedWhy: 'السبب:',
    editApplication: 'عدل الطلب',
    submitAgain: 'صيفط من جديد',
    confirmResubmit: 'واخا تصيفط الطلب من جديد؟',
    saveChanges: 'سجل التبديلات',
...
const fr: typeof ar = {
  ...
  owner: {
    ...
    // O1 — registration
    registerTitle: 'Enregistre ton lavage',
    stepIdentity: 'Nom', stepLocation: 'Lieu',
    stepPhotos: 'Photos', stepDetails: 'Détails',
    washNameHint: 'Par exemple : Lavage Ennour',
    washDescriptionHint: 'Qu’est-ce qui te distingue ?',
    washAddressHint: 'Rue et numéro',
    washCity: 'Ville',
    pinHint: 'Déplace le point jusqu’à l’emplacement exact du lavage.',
    pinHelp: 'Les clients viendront à ce point. Vérifie-le.',
    addPhotos: 'Ajouter des photos',
    removePhoto: 'Retirer cette photo ?',
    photosCount: '{{count}} photos — il en faut {{min}} au minimum',
    photosPermission: 'Nous avons besoin de l’accès aux photos.',
    photosWhy: 'Les photos sont la première chose que voit un client. Mets-en au moins 3 : la façade, les places, le travail fini.',
    reviewTitle: 'Vérifie avant d’envoyer',
    submitApplication: 'Envoyer la demande',
    fixBeforeSubmit: 'Il manque encore quelque chose.',
    // problems
    problemNameMissing: 'Le nom du lavage est obligatoire.',
    problemAddressMissing: 'L’adresse est obligatoire.',
    problemCityMissing: 'La ville est obligatoire.',
    problemPinMissing: 'Place le point sur la carte.',
    problemPinOutsideMorocco: 'Ce point n’est pas au Maroc.',
    problemTooFewPhotos: 'Il faut au moins {{count}} photos.',
    problemTooManyPhotos: 'Trop de photos.',
    problemBaysOutOfRange: 'Ce nombre de places n’est pas réaliste.',
    problemHoursIdentical: 'L’ouverture et la fermeture sont identiques.',
    // O2 — waiting
    pendingTitle: 'Ta demande est chez l’administration',
    pendingBody: 'Nous te répondons sous 48 heures.',
    rejectedTitle: 'Ta demande a été refusée',
    rejectedWhy: 'Raison :',
    editApplication: 'Modifier la demande',
    submitAgain: 'Envoyer à nouveau',
    confirmResubmit: 'Envoyer la demande à nouveau ?',
...
const en: typeof ar = {
  ...
  owner: {
    ...
    // O1 — registration
    registerTitle: 'Register your car wash',
    stepIdentity: 'Name', stepLocation: 'Place',
    stepPhotos: 'Photos', stepDetails: 'Details',
    washNameHint: 'For example: Lavage Ennour',
    washDescriptionHint: 'What sets you apart?',
    washAddressHint: 'Street and number',
    washCity: 'City',
    pinHint: 'Drag the point to exactly where the car wash is.',
    pinHelp: 'Clients will drive to this point. Check it.',
    addPhotos: 'Add photos',
    removePhoto: 'Remove this photo?',
    photosCount: '{{count}} photos — at least {{min}} needed',
    photosPermission: 'We need access to your photos.',
    photosWhy: 'Photos are the first thing a client sees. Add at least 3: the front, the bays, the finished work.',
    reviewTitle: 'Check before you send',
    submitApplication: 'Send the application',
    fixBeforeSubmit: 'Something is still missing.',
    // problems
    problemNameMissing: 'The car wash needs a name.',
    problemAddressMissing: 'The address is required.',
    problemCityMissing: 'The city is required.',
    problemPinMissing: 'Place the point on the map.',
    problemPinOutsideMorocco: 'That point is not in Morocco.',
    problemTooFewPhotos: 'At least {{count}} photos are needed.',
    problemTooManyPhotos: 'Too many photos.',
    problemBaysOutOfRange: 'That number of bays is not realistic.',
    problemHoursIdentical: 'Opening and closing times are the same.',
    // O2 — waiting
    pendingTitle: 'Your application is with the admin',
    pendingBody: 'We will get back to you within 48 hours.',
    rejectedTitle: 'Your application was not accepted',
    rejectedWhy: 'Reason:',
    editApplication: 'Edit the application',
    submitAgain: 'Submit again',
    confirmResubmit: 'Submit the application again?',
